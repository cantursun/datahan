    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ $about->title.' Güncelle' ?? 'Güncelle' }}</h1>
                    </div>
                    <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="is_published" id="isPublished" class="form-control" required>
                                            <option value="1" {{ $about->is_published ? "selected" : "" }}>Göster</option>
                                            <option value="0" {{ !$about->is_published ? "selected" : "" }}>Gizle</option>
                                        </select>
                                    </div>
                                </div>
